...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		if (User.permission_level == 4) and IsControlJustPressed(1,157) then
...
Citizen.CreateThread(function()
	while true do
		...
		local _,_,x,y,z = string.find( pos or "0,0,0", "([(%-|'')%w+%.%d+]+),([(%-|'')%w+%.%d+]+),([(%-|'')%w+%.%d+]+)" )
...
-- TELEPORTATION COORDONEES
function teleportation()

end
-- FIN TELEPORTATION COORDONEES
